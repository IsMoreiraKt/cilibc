...
Full documentation on the autobot is available at [docs/autobot/](./docs/autobot/).
...
- **Users:** See [docs/guides/](./docs/guides/) for usage tips, code snippets, installation and configuration guides, tuning advice, and testing instructions.
- **Developers:** Check [docs/dev-docs/](./docs/dev-docs/) for security guidelines, architecture overviews, development practices, implementation details, and references to external documentation (e.g., POSIX headers).
...
- **Build system docs:** [docs/autobot/](./docs/autobot/) holds all information related to our build/test helper bot, commands, usage guides, and troubleshooting.
